...
import { ProfileplaylistPage } from '../profileplaylist/profileplaylist';

/**
 * Generated class for the ProfilmusicPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-profilmusic',
  templateUrl: 'profilmusic.html',
})
export class ProfilmusicPage {
  ...
  loadPlaylistP()
  {
    this.navCtrl.push(ProfileplaylistPage);
  }
