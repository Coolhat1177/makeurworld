...
import { ProfilefavPage } from '../profilefav/profilefav';


/**
 * Generated class for the ProfilevideoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-profilevideo',
  templateUrl: 'profilevideo.html',
})
export class ProfilevideoPage {
  ...
  loadFavouriteP()
  {
    this.navCtrl.push(ProfilefavPage);
